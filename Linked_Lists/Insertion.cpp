...
int main()
{
	...
	// Insert 6. So linked list becomes 8->NULL
	append(&head, 8);
	
	// Insert 7 at the beginning.
	// So linked list becomes 5->8->NULL
	push(&head, 8);
	
	// Insert 1 at the beginning.
	// So linked list becomes 3->5->8->NULL
	push(&head, 3);
	
	// Insert 4 at the end. So
	// linked list becomes 3->5->8->4->NULL
	append(&head, 4);
	
	// Insert 8, after 7. So linked
	// list becomes 1->7->0->6->4->NULL
